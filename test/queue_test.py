...
class QueueTest(unittest.TestCase):
    ...
    def test_next(self):
        ...
        self.assertEqual(self.queue._container, deque([2,3,4,5,6,7,8,9,1]))

    def test_prev(self):
        self.queue.prev()
        self.assertEqual(self.queue.peek(), 9)
        self.assertEqual(self.queue._container, deque([9,1,2,3,4,5,6,7,8]))

    def test_seek(self):
        self.queue.seek(6)
        self.assertEqual(self.queue._container, deque([6,7,8,9,1,2,3,4,5]))
        self.assertEqual(self.queue.peek(), 6)

        self.queue.seek(86)
        self.assertEqual(self.queue._container, deque([86,7,8,9,1,2,3,4,5,6]))
        self.assertEqual(self.queue.peek(), 86)
    
    def test_shuffle(self):
        self.queue.shuffle()
        self.assertEqual(self.queue.peek(), 1)
        self.assertNotEqual(self.queue._container, deque([1,2,3,4,5,6,7,8,9]))
    
    def test_append(self):
        self.queue.append(77)
        self.queue.append([1,2,5,89,45,23])
        self.assertEqual(self.queue._container, deque([3,4,6,7,8,9,77,1,2,5,89,45,23]))
        self.assertEqual(self.queue.peek(), 1)
    ...
    def test_prepend(self):
        ...
        self.assertEqual(self.queue._container, deque([1,23,8,9,3,77,2,4,5,6,7]))
        self.assertEqual(self.queue.peek(), 1)
